...
import { abbreviateNumber, numberGenerator } from "./number";
...
describe("#abbreviateNumber", () => {
  ...
  describe('when multiple units(["M","T"]) are given', () => {
    ...
    it("should return a string representation of the rounded number when negative", () => {
      expect(abbreviateNumber(-7008, 0, ["M", "T"])).toBe("-7M");
    });
  });
});
...
describe("#numberGenerator", () => {
  it("should generate a indice sequency", () => {
