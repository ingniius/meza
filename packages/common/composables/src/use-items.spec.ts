...
import { isEqual } from "@azem/utils/lodash";
...
it("should fetch filter count and total count only once", async () => {
...
it("should fetch distinct filter count and total count only once", async () => {
...
it("should not re-fetch filter count when changing fields query", async () => {
  vi.mocked(useCollection).mockReturnValueOnce({ primaryKeyField: computed(() => null) } as any);
...
it("should re-fetch filter count when changing filters query", async () => {
  vi.mocked(useCollection).mockReturnValueOnce({ primaryKeyField: computed(() => null) } as any);
...
it("should re-fetch total count when changing system filter", async () => {
  vi.mocked(useCollection).mockReturnValueOnce({ primaryKeyField: computed(() => null) } as any);
...
it("should re-fetch filter count when changing search query", async () => {
  vi.mocked(useCollection).mockReturnValueOnce({ primaryKeyField: computed(() => null) } as any);
...
it("should reset when collection changes", async () => {
  vi.mocked(useCollection).mockReturnValueOnce({ primaryKeyField: computed(() => null) } as any);
...
it("should append $thumbnail to fetched items when collection is meza_files", async () => {
  vi.mocked(useCollection).mockReturnValueOnce({ primaryKeyField: computed(() => null) } as any);

  const collection = ref("meza_files");
