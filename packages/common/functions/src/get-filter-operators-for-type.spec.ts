...
describe("#getFilterOperatorsForType", () => {
  it("should return the filter operators for alias", () => {
  ...
  it("should return the filter operators for boolean", () => {
    expect(getFilterOperatorsForType("boolean")).toStrictEqual(["eq", "neq", "null", "nnull"]);
  });

  it("should return the filter operators for dateTime", () => {
  ...
  it("should return the filter operators for float", () => {
  ...
  it("should return the filter operators for integer", () => {
  ...
  it("should return the filter operators for json", () => {
    expect(getFilterOperatorsForType("json")).toStrictEqual(["null", "nnull"]);
  });

  it("should return the filter operators for binary", () => {
  ...
  it("should return the filter operators for geometry", () => {
