import { clone } from "@azem/utils/lodash";
 ...
 * @publicApi
 * @name adjustDate
 * @description Adjust a given date by a given change in duration. The adjustment value uses the exact same syntax and logic as Vercel's `ms`.
