import { getAuthEndpoint } from "../rest/utils/get-auth-endpoint";
...
/**
 * @private
 * @description setTimeout breaks with numbers bigger than 32bits.
 ...
 * @publicApi
 * @name authentication
 * @description Creates a client to authenticate with Meza.
...
export const authentication = (mode: AuthenticationMode = "cookie", config: Partial<AuthenticationConfig> = {}) => {
  return <Schema>(client: MezaClient<Schema>): AuthenticationClient<Schema> => {
