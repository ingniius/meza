import { queryToParams } from "../index";
...
/**
 * @internal
 * @description Build URL based on provided options.
 * @param baseUrl The base URL
 * @param options The request options
 */
export function getRequestUrl(baseUrl: URL, path: string, params?: Record<string, any>): URL {
