import type { ArrayFunctions, DateTimeFunctions, MappedFieldNames, MappedFunctionFields } from "./functions";
import type { AllCollections, GetCollection, LiteralFields, Query, RelationalFields, UnpackList } from "./index";

/**
 * @publicApi
 * @description Strings are used to ensure precision and prevent overflows.
 */
...
/**
 * @publicApi
 * @description Aggregation input options/
 */
...
/**
 * @publicApi
 * @description Output typing for aggregation.
 */
...
/**
 * @publicApi
 * @description GroupBy parameters.
 */
...
/**
 * @private
 * @description Translate function names based on provided map.
 */
...
/**
 * @private
 * @description Wrap fields in functions.
 */
