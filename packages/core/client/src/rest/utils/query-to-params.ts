 ...
 * @name formatFields
 */
export function formatFields(fields: (string | Record<string, any>)[]) {
 ...
 * @publicApi
 * @name queryToParams
 * @description Transform nested query object to an url compatible format.
 * @param query The nested query object
 */
export function queryToParams<Schema, Item>(query: ExtendedQuery<Schema, Item>): Record<string, string> {
