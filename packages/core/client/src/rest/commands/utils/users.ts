 ...
 * @description Accept your invite. The invite user endpoint sends the email a link to the Admin App.
 ...
 * @description Verify a registered user email using a token sent to the address.
 ...
 * @description Adds a TFA secret to the user account.
 ...
 * @description Disables two-factor authentication by removing the OTP secret from the user.
