  ...
  plop.setGenerator("package", {
    ...
    actions: [
      ...
      // TEMPLATES
      {
        ...
        templateFile: "pkg/package.json.hbs",
      },
      {
        type: "add",
        path: "packages/{{ scope }}/{{ name }}/eslint.config.mjs",
        templateFile: "pkg/eslint.config.mjs.hbs",
      },
      {
        type: "add",
        path: "packages/{{ scope }}/{{ name }}/tsconfig.json",
        templateFile: "pkg/tsconfig.json.hbs",
      },
      {
        type: "add",
        path: "packages/{{ scope }}/{{ name }}/build.config.ts",
        templateFile: "pkg/build.config.ts.hbs",
      },
      {
        type: "add",
        path: "packages/{{ scope }}/{{ name }}/vitest.config.ts",
        templateFile: "pkg/vitest.config.ts.hbs",
      },
      // GENERATOR
      {
        type: "add",
